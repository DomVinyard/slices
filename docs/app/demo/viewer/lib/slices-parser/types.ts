/**
 * Type definitions for Slices (.tt) files.
 * This is the canonical source for all Slices types.
 */
...
/**
 * Frontmatter metadata for a Slices file (all fields optional for parsing).
 */
...
export interface StrictTTFrontmatter extends TTFrontmatter {
  /** Slices spec version (guaranteed present) */
  v: string;
...
/**
 * A complete Slices file for SDK operations.
